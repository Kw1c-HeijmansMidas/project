...
*/
                if($change > 0)
                {
                    ...
                    elseif ($choice == "fanta")
                    {
                        echo "U heeft voor Fanta gekozen";
                    }
                    echo $change;
                }
                ...
                if($money < 1.5)
                {
                    echo "U heeft niet genoeg geld ingeworpen.";
                }
                echo "U heeft ingeworpen " . $money. "<br>";
                echo "U heeft nog " . (1.5-$money);
                // tot hier
            }
